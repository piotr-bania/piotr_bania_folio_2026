export const NUVORI = {
    ...
    root: {
        ...
        description: `
            Nuvori is a restaurant booking system built from 20 years of firsthand hospitality experience. Existing solutions are designed as marketplaces - they charge per cover, control customer data, and force restaurants into platforms that prioritise diners over operators. Nuvori flips that model. It gives full control back to venues: their bookings, their data, their experience. It is designed as a white-label system that integrates directly into the restaurant’s own website  while providing a powerful operational backend for staff.
        `,
        ...
        media: [
            {
                ...
                type: "image",
                src: "/media/core_systems/nuvori/image_1.webp",
            ...
            },
            {
                ...
                label: "Admin system",
                type: "image",
                src: "/media/core_systems/nuvori/image_2.webp",
    ...
    system: {
        title: "System layers",
        description: `
            Nuvori operates across multiple layers that together form a complete hospitality operating system. Each layer can be used independently or as part of a full system rollout.
        `,
    ...
    evidence: {
        ...
        description: `
            Nuvori is not theoretical. It is currently running as a live pilot for Yaki Sarsa, integrated directly into a production restaurant website. It is actively used to collect bookings and is being iterated based on real operational feedback.
        `,
        ...
        media: [
            {
                ...
                label: "Booking flow (static)",
                type: "image",
                src: "/media/core_systems/nuvori/image_3.webp",
                alt: "Full booking flow within Nuvori widget.",
                interaction: "glsl_plane_popup",
            },
            {
                id: "nuvori_admin_full",
                label: "Admin interface (static)",
                type: "image",
                src: "/media/core_systems/nuvori/image_4.webp",
                alt: "Admin system showing live booking management.",
                interaction: "glsl_plane_popup",
            },
            {
                id: "nuvori_admin_video",
                label: "Admin flow (live)",
                type: "video",
                src: "/media/core_systems/nuvori/nuvori_admin.webm",
                alt: "Nuvori admin system showing live booking updates and interactions.",
                interaction: "glsl_plane_popup",
            },
            {
                id: "nuvori_booking_video",
                label: "Booking flow (live)",
                type: "video",
                src: "/media/core_systems/nuvori/nuvori_booking.webm",
                alt: "Complete booking flow from selection to confirmation within Nuvori widget.",
                interaction: "glsl_plane_popup",
            },
        ],
    },
