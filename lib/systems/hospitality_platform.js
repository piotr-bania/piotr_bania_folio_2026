export const HOSPITALITY_PLATFORM = {
    ...
    root: {
        ...
        description: `
            Hospitality Platform is the underlying system I use to build, operate, and scale multiple restaurant projects.

            Instead of building isolated websites and tools, I created a shared architecture that supports multiple venues
            from a single system. It handles data, media, structure, and operational logic across projects.

            This is what allows rapid development, consistent quality, and long-term scalability across hospitality clients.
        `,
        ...
        media: [
            {
                ...
                type: "image",
                src: "/media/core_systems/hospitality_platform/hospitality_platform_1.png",
    ...
    architecture: {
        ...
        description: `
            The platform is built as a multi-tenant system using Next.js and Supabase.

            Each restaurant operates as an isolated tenant with its own data, branding, and configuration,
            while sharing a common system layer. This allows multiple projects to run on the same architecture
            without duplication or fragmentation.

            Supabase provides authentication, storage, and row-level security to ensure strict tenant isolation,
            while Next.js handles the application layer and rendering.
        `,
    ...
    system: {
        title: "System role",
        description: `
            This platform is not a visible product on its own. It is the system layer that powers everything else.

            Nuvori, client websites, and future hospitality tools are all built on top of this foundation.
            It enables faster delivery, better consistency, and long-term scalability across projects.
        `,
    ...
    evidence: {
        ...
        description: `
            The platform is actively used in real projects. It is not theoretical or experimental.
            It powers live systems and handles real operational data.
        `,
